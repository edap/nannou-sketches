// Generated automatically from record.xml by rs_client.py version 0.9.0.
// Do not edit!
...
impl base::CookieSeq for xcb_record_query_version_cookie_t {
...
impl base::CookieSeq for xcb_record_get_context_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_record_enable_context_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
