// Generated automatically from xf86dri.xml by rs_client.py version 0.9.0.
// Do not edit!
...
impl base::CookieSeq for xcb_xf86dri_query_version_cookie_t {
...
impl base::CookieSeq for xcb_xf86dri_query_direct_rendering_capable_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<QueryDirectRenderingCapableReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = QueryDirectRenderingCapableReply {
...
impl base::CookieSeq for xcb_xf86dri_open_connection_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_xf86dri_get_client_driver_name_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<GetClientDriverNameReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = GetClientDriverNameReply {
...
impl base::CookieSeq for xcb_xf86dri_create_context_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_xf86dri_create_drawable_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_xf86dri_get_drawable_info_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_xf86dri_get_device_info_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_xf86dri_auth_connection_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
