...
impl base::CookieSeq for xcb_randr_query_version_cookie_t {
...
impl base::CookieSeq for xcb_randr_set_screen_config_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_screen_info_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_screen_size_range_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<GetScreenSizeRangeReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = GetScreenSizeRangeReply {
...
impl base::CookieSeq for xcb_randr_get_screen_resources_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<GetScreenResourcesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = GetScreenResourcesReply {
...
impl base::CookieSeq for xcb_randr_get_output_info_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_list_output_properties_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<ListOutputPropertiesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = ListOutputPropertiesReply {
...
impl base::CookieSeq for xcb_randr_query_output_property_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<QueryOutputPropertyReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = QueryOutputPropertyReply {
...
impl base::CookieSeq for xcb_randr_get_output_property_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<GetOutputPropertyReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = GetOutputPropertyReply {
...
impl base::CookieSeq for xcb_randr_create_mode_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_crtc_info_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_set_crtc_config_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_crtc_gamma_size_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_crtc_gamma_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_screen_resources_current_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<GetScreenResourcesCurrentReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = GetScreenResourcesCurrentReply {
...
impl base::CookieSeq for xcb_randr_get_crtc_transform_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_panning_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_set_panning_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_output_primary_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_providers_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_get_provider_info_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_randr_list_provider_properties_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<ListProviderPropertiesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = ListProviderPropertiesReply {
...
impl base::CookieSeq for xcb_randr_query_provider_property_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<QueryProviderPropertyReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = QueryProviderPropertyReply {
...
impl base::CookieSeq for xcb_randr_get_provider_property_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<GetProviderPropertyReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = GetProviderPropertyReply {
