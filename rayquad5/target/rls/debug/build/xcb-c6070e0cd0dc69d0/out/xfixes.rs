// Generated automatically from xfixes.xml by rs_client.py version 0.9.0.
// Do not edit!
    ...
    pub fn get_reply(self) -> Result<GetCursorImageAndNameReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = GetCursorImageAndNameReply {
