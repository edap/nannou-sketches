// Generated automatically from xvmc.xml by rs_client.py version 0.9.0.
// Do not edit!
    ...
    pub fn get_reply(self) -> Result<ListSubpictureTypesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = ListSubpictureTypesReply {
