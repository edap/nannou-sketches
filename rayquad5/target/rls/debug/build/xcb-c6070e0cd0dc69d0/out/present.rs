// Generated automatically from present.xml by rs_client.py version 0.9.0.
// Do not edit!
...
impl base::CookieSeq for xcb_present_query_version_cookie_t {
...
impl base::CookieSeq for xcb_present_query_capabilities_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<QueryCapabilitiesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = QueryCapabilitiesReply {
