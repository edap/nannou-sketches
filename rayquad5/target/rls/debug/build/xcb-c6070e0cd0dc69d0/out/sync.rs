...
impl base::CookieSeq for xcb_sync_initialize_cookie_t {
...
impl base::CookieSeq for xcb_sync_list_system_counters_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<ListSystemCountersReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = ListSystemCountersReply {
...
impl base::CookieSeq for xcb_sync_query_counter_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_sync_query_alarm_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_sync_get_priority_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_sync_query_fence_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
