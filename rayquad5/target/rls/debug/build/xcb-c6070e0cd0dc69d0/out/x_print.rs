// Generated automatically from xprint.xml by rs_client.py version 0.9.0.
// Do not edit!
...
impl base::CookieSeq for xcb_x_print_print_query_version_cookie_t {
    ...
    pub fn get_reply(self) -> Result<PrintQueryVersionReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintQueryVersionReply {
...
impl base::CookieSeq for xcb_x_print_print_get_printer_list_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintGetPrinterListReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintGetPrinterListReply {
...
impl base::CookieSeq for xcb_x_print_print_get_context_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
...
impl base::CookieSeq for xcb_x_print_print_get_screen_of_context_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintGetScreenOfContextReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintGetScreenOfContextReply {
...
impl base::CookieSeq for xcb_x_print_print_get_document_data_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintGetDocumentDataReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintGetDocumentDataReply {
...
impl base::CookieSeq for xcb_x_print_print_input_selected_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintInputSelectedReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintInputSelectedReply {
...
impl base::CookieSeq for xcb_x_print_print_get_attributes_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintGetAttributesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintGetAttributesReply {
...
impl base::CookieSeq for xcb_x_print_print_get_one_attributes_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintGetOneAttributesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintGetOneAttributesReply {
...
impl base::CookieSeq for xcb_x_print_print_get_page_dimensions_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintGetPageDimensionsReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintGetPageDimensionsReply {
...
impl base::CookieSeq for xcb_x_print_print_query_screens_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintQueryScreensReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintQueryScreensReply {
...
impl base::CookieSeq for xcb_x_print_print_set_image_resolution_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintSetImageResolutionReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintSetImageResolutionReply {
...
impl base::CookieSeq for xcb_x_print_print_get_image_resolution_cookie_t {
    fn sequence(&self) -> c_uint { self.sequence }
}
    ...
    pub fn get_reply(self) -> Result<PrintGetImageResolutionReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = PrintGetImageResolutionReply {
