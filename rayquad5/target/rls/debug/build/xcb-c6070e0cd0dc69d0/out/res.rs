// Generated automatically from res.xml by rs_client.py version 0.9.0.
// Do not edit!
    ...
    pub fn get_reply(self) -> Result<QueryClientResourcesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = QueryClientResourcesReply {
    ...
    pub fn get_reply(self) -> Result<QueryClientPixmapBytesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = QueryClientPixmapBytesReply {
    ...
    pub fn get_reply(self) -> Result<QueryResourceBytesReply, base::GenericError> {
        unsafe {
            if self.checked {
                ...
                let res = QueryResourceBytesReply {
