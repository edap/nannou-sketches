...
impl Palette {
    pub fn new() -> Self {
        let colors_rgb: [Rgb; 30] = [
            ...
            //Nes Variation 2
            rgb(0.921568627, 0.960784314, 0.337254902), // giallo limone
            rgb(0.121568627, 0.760784314, 0.42745098),  // verde chiaro
            rgb(1.0, 0.054901961, 0.152941176),         // rosso carminio
            rgb(0.745098039, 0.8, 0.0),                 // verde oliva chiaro
            rgb(0.0, 0.521568627, 0.980392157),         // azzurro
        ];
